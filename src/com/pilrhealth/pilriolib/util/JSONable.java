...
public interface JSONable {
	/**
	 * Must return a JSON-compliant representation of this object, in the form
	 * of a JSONObject.
	 * 
	 * @return The JSONObject representation.
	 * @throws JSONException
	 *             if any of the underlying JSONObject members throws.
	 ...
	 * @throws JSONException
	 *             If any JSONObject members throw. Implementations may
	 *             optionally throw if the input object violates the expected
	 *             structure.
	 */
